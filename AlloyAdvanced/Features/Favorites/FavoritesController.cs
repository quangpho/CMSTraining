...
namespace AlloyAdvanced.Features.Favorites
{
    public class FavoritesController : Controller
    {
        ...
        public ActionResult Manager(SitePageData currentPage)
        {
            ...
            model.Favorites = FavoriteRepository.GetFavorites(PrincipalInfo.Current.Name);
        ...
        {
            var favorite = FavoriteRepository.GetFavorite(page, PrincipalInfo.Current.Name);
            if (favorite == null)
            {
        ...
        {
            var favorite = FavoriteRepository.GetFavorite(fav, PrincipalInfo.Current.Name);
            if (favorite != null)
            {
